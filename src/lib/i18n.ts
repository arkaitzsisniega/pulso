...
export const CATALOGO: Record<string, Entrada> = {
  // ── Informe de partido (completado 1/9/2026: todo lo del informe
  //    del club salvo lo que necesita GPS) ──
  inf_cargando: { es: "Cargando…", en: "Loading…", it: "Caricamento…" },
  inf_sin_partido: { es: "No hay ningún partido abierto.", en: "No match is open.", it: "Non c'è nessuna partita aperta." },
  inf_volver: { es: "Volver", en: "Back", it: "Indietro" },
  inf_guardar_pdf: { es: "Guardar como PDF", en: "Save as PDF", it: "Salva come PDF" },
  inf_aviso_imprimir: { es: "Se abrirá el cuadro de imprimir del iPad. Ahí eliges Guardar en Archivos, o lo compartes por correo o WhatsApp desde el mismo sitio.", en: "The iPad print dialog will open. Choose Save to Files there, or share it by email or WhatsApp from the same place.", it: "Si aprirà la finestra di stampa dell'iPad. Da lì scegli Salva su File, oppure lo condividi per email o WhatsApp dallo stesso posto." },
  inf_titulo: { es: "Informe de partido", en: "Match report", it: "Report della partita" },
  inf_local: { es: "Local", en: "Home", it: "In casa" },
  inf_visitante: { es: "Visitante", en: "Away", it: "In trasferta" },
  inf_con_video: { es: "revisado con vídeo", en: "reviewed on video", it: "rivisto con il video" },
  inf_en_directo: { es: "apuntado en directo", en: "recorded live", it: "registrato dal vivo" },
  inf_sec_goles: { es: "Goles", en: "Goals", it: "Gol" },
  inf_sin_goles: { es: "Sin goles.", en: "No goals.", it: "Nessun gol." },
  inf_asist: { es: "asist.", en: "assist", it: "assist" },
  inf_sec_equipo: { es: "Estadísticas del partido", en: "Match statistics", it: "Statistiche della partita" },
  inf_disparos: { es: "Disparos", en: "Shots", it: "Tiri" },
  inf_a_puerta: { es: "A puerta", en: "On target", it: "In porta" },
  inf_fuera: { es: "Fuera", en: "Off target", it: "Fuori" },
  inf_palo: { es: "Al palo", en: "Woodwork", it: "Sul palo" },
  inf_bloqueados: { es: "Bloqueados", en: "Blocked", it: "Murati" },
  inf_faltas: { es: "Faltas", en: "Fouls", it: "Falli" },
  inf_amarillas: { es: "Amarillas", en: "Yellow cards", it: "Ammonizioni" },
  inf_tm: { es: "Tiempos muertos", en: "Timeouts", it: "Time out" },
  inf_robos: { es: "Robos", en: "Steals", it: "Recuperi" },
  inf_cortes: { es: "Cortes", en: "Interceptions", it: "Intercetti" },
  inf_perdidas: { es: "Pérdidas", en: "Turnovers", it: "Palle perse" },
  inf_divididos: { es: "Divididos", en: "50-50s", it: "Palle contese" },
  inf_sec_jugadores: { es: "Jugadores de campo", en: "Outfield players", it: "Giocatori di movimento" },
  inf_jugador: { es: "Jugador", en: "Player", it: "Giocatore" },
  inf_min: { es: "Min", en: "Min", it: "Min" },
  inf_asist_col: { es: "Asist.", en: "Ast.", it: "Assist" },
  inf_disp: { es: "Disp.", en: "Sh.", it: "Tiri" },
  inf_pta: { es: "A pta.", en: "On tgt.", it: "In porta" },
  inf_perd: { es: "Pérd.", en: "TO", it: "Perse" },
  inf_bd: { es: "Divid.", en: "50-50", it: "Contese" },
  inf_nota_masmenos: { es: "± = goles a favor menos goles en contra con ese jugador en pista.", en: "± = goals for minus goals against while that player was on court.", it: "± = gol fatti meno gol subiti con quel giocatore in campo." },
  inf_sec_porteros: { es: "Porteros", en: "Goalkeepers", it: "Portieri" },
  inf_portero: { es: "Portero", en: "Goalkeeper", it: "Portiere" },
  inf_paradas: { es: "Paradas", en: "Saves", it: "Parate" },
  inf_encajados: { es: "Encajados", en: "Conceded", it: "Subiti" },
  inf_pct_parada: { es: "% parada", en: "Save %", it: "% parate" },
  inf_sec_cronograma: { es: "Rotaciones", en: "Rotations", it: "Rotazioni" },
  inf_nota_cronograma: { es: "Cada barra son los tramos que ese jugador estuvo en pista, de principio a fin del partido.", en: "Each bar shows the spells that player spent on court, from start to end of the match.", it: "Ogni barra sono i tratti in cui quel giocatore è stato in campo, dall'inizio alla fine della partita." },
  inf_sec_quintetos: { es: "Rendimiento por quinteto", en: "Performance by lineup", it: "Rendimento per quintetto" },
  inf_titulares: { es: "Quinteto inicial", en: "Starting five", it: "Quintetto iniziale" },
  inf_kpi_disparos: { es: "Disparos", en: "Shots", it: "Tiri" },
  inf_kpi_apuerta: { es: "A puerta", en: "On target", it: "In porta" },
  inf_kpi_faltas: { es: "Faltas", en: "Fouls", it: "Falli" },
  inf_kpi_duracion: { es: "Duración", en: "Duration", it: "Durata" },
  inf_kpi_efectividad: { es: "Efectividad", en: "Conversion", it: "Efficacia" },
  inf_sec_valoracion: { es: "Valoración del partido", en: "Match rating", it: "Valutazione della partita" },
  inf_val: { es: "Val.", en: "Rating", it: "Val." },
  inf_val_40: { es: "Val./40'", en: "Rating/40'", it: "Val./40'" },
  inf_val_video: { es: "De vídeo", en: "From video", it: "Da video" },
  inf_nota_val: {
    es: "La valoración es la SUMA de puntos por acción, sin techo: un partidazo puede ser 20 y un mal partido, negativo. Val./40' es el ritmo, para comparar a quien juega 12 minutos con quien juega 40. Gol +3 · asistencia +2 · robo +1 · corte +0,75 · dividido ganado +0,5 / perdido −0,25 · disparo a puerta +0,4 · palo +0,3 · bloqueado +0,1 · fuera +0,05 · pérdida forzada −0,75 / no forzada −1,5 · gol a favor en pista +1 / en contra −1 · falta −0,25 · amarilla −0,5 · roja −2. Porteros: parada +0,8 · gol encajado −1,5 · portería a cero (≥20') +2. La columna «De vídeo» son los duelos, 1x1, anticipaciones, pases de gol (+2, como una asistencia), coberturas, saques y pases, que solo se cogen revisando la grabación.",
    en: "The rating is the SUM of points per action, with no cap: a great match can be 20 and a poor one, negative. Rating/40' is the rate, so a player with 12 minutes can be compared with one who played 40. Goal +3 · assist +2 · steal +1 · interception +0.75 · loose ball won +0.5 / lost −0.25 · shot on target +0.4 · post +0.3 · blocked +0.1 · off target +0.05 · forced turnover −0.75 / unforced −1.5 · goal for while on court +1 / against −1 · foul −0.25 · yellow −0.5 · red −2. Goalkeepers: save +0.8 · goal conceded −1.5 · clean sheet (≥20') +2. The «From video» column is duels, one-on-ones, anticipations, key passes (+2, like an assist), covers, throws and passes, which only come from reviewing the footage.",
    it: "La valutazione è la SOMMA dei punti per azione, senza tetto: una grande partita può valere 20 e una brutta, negativo. Val./40' è il ritmo, per confrontare chi gioca 12 minuti con chi ne gioca 40. Gol +3 · assist +2 · recupero +1 · intercetto +0,75 · palla contesa vinta +0,5 / persa −0,25 · tiro in porta +0,4 · palo +0,3 · murato +0,1 · fuori +0,05 · palla persa forzata −0,75 / non forzata −1,5 · gol a favore in campo +1 / contro −1 · fallo −0,25 · giallo −0,5 · rosso −2. Portieri: parata +0,8 · gol subito −1,5 · porta inviolata (≥20') +2. La colonna «Da video» sono duelli, uno contro uno, anticipi, passaggi chiave (+2, come un assist), coperture, rilanci e passaggi, che si raccolgono solo rivedendo la registrazione.",
  },
  inf_nota_val_directo: {
    es: "Este partido se apuntó en directo, así que la nota no incluye lo que solo se coge revisando el vídeo (duelos, 1x1, anticipaciones, pases de gol, coberturas, saques). Al rehacerlo con el vídeo, la valoración cambia.",
    en: "This match was recorded live, so the rating leaves out everything that only comes from reviewing the footage (duels, one-on-ones, anticipations, key passes, covers, throws). Redo it with video and the rating changes.",
    it: "Questa partita è stata registrata dal vivo, quindi la valutazione non include ciò che si ricava solo rivedendo il video (duelli, uno contro uno, anticipi, passaggi chiave, coperture, rilanci). Rifacendola con il video, la valutazione cambia.",
  },
  inf_sec_rotaciones: { es: "Rotaciones individuales", en: "Individual rotations", it: "Rotazioni individuali" },
  inf_periodos: { es: "Periodos en pista", en: "Spells on court", it: "Periodi in campo" },
  inf_veces: { es: "Veces", en: "Spells", it: "Volte" },
  inf_nota_rotaciones: {
    es: "Cada periodo es un tramo seguido en pista: de cuándo entró a cuándo salió.",
    en: "Each spell is an unbroken run on court: from going on to coming off.",
    it: "Ogni periodo è un tratto continuo in campo: da quando entra a quando esce.",
  },
  inf_sec_cuartetos: { es: "Rendimiento por cuarteto", en: "Performance by outfield four", it: "Rendimento per quartetto" },
  inf_cuarteto: { es: "Cuarteto", en: "Outfield four", it: "Quartetto" },
  inf_nota_cuartetos: {
    es: "El cuarteto son los cuatro de campo, sin el portero: el portero cambia por motivos que no son de juego y ensuciaría la comparación.",
    en: "The four outfield players, goalkeeper excluded: the keeper changes for reasons unrelated to play and would blur the comparison.",
    it: "Il quartetto sono i quattro di movimento, senza il portiere: il portiere cambia per motivi che non riguardano il gioco e falserebbe il confronto.",
  },
  inf_sec_tramos: { es: "Cuándo se marcaron los goles", en: "When the goals came", it: "Quando sono arrivati i gol" },
  inf_nota_tramos: {
    es: "Goles por tramos de cinco minutos. En verde los nuestros, en rojo los del rival.",
    en: "Goals in five-minute blocks. Ours in green, the opponent's in red.",
    it: "Gol in blocchi di cinque minuti. In verde i nostri, in rosso quelli avversari.",
  },
  inf_sec_tanda: { es: "Tanda de penaltis", en: "Penalty shootout", it: "Serie di rigori" },
  inf_equipo: { es: "Equipo", en: "Team", it: "Squadra" },
  ...
  inf_m_perdidas: { es: "Pérdidas", en: "Turnovers", it: "Palle perse" },
  inf_m_faltas: { es: "Faltas cometidas", en: "Fouls conceded", it: "Falli commessi" },
  inf_nota_mapas_juego: {
    es: "Solo salen en los partidos revisados con vídeo: en directo no da tiempo a marcar el sitio de cada acción, así que el mapa saldría vacío en vez de equivocado.",
    en: "Only in matches reviewed on video: live there is no time to mark where each action happened, so the map would come out empty rather than wrong.",
    it: "Solo nelle partite riviste con il video: dal vivo non c'è tempo per segnare dove avviene ogni azione, quindi la mappa resterebbe vuota invece che sbagliata.",
  },
  inf_quinteto: { es: "Quinteto", en: "Lineup", it: "Quintetto" },
  inf_gf: { es: "GF", en: "GF", it: "GF" },
  inf_gc: { es: "GC", en: "GA", it: "GS" },
  inf_nota_quintetos: { es: "Los diez quintetos con más minutos. ± = goles a favor menos en contra con ellos en pista.", en: "The ten lineups with most minutes. ± = goals for minus against while on court.", it: "I dieci quintetti con più minuti. ± = gol fatti meno subiti con loro in campo." },
  inf_sec_jugadas: { es: "Goles por tipo de jugada", en: "Goals by type of play", it: "Gol per tipo di azione" },
  inf_jugada: { es: "Jugada", en: "Play", it: "Azione" },
  inf_sec_zonas: { es: "Mapas de zona", en: "Zone maps", it: "Mappe di zona" },
  inf_z_porteria_favor: { es: "Portería · a favor", en: "Goal mouth · for", it: "Porta · a favore" },
  inf_z_campo_favor: { es: "Zonas de disparo · a favor", en: "Shooting zones · for", it: "Zone di tiro · a favore" },
  inf_z_porteria_contra: { es: "Portería · en contra", en: "Goal mouth · against", it: "Porta · contro" },
  inf_z_campo_contra: { es: "Zonas de disparo · en contra", en: "Shooting zones · against", it: "Zone di tiro · contro" },
  inf_sec_video: { es: "Duelos y uno contra uno", en: "Duels and one-on-ones", it: "Duelli e uno contro uno" },
  inf_video_porteros: { es: "Porteros", en: "Goalkeepers", it: "Portieri" },
  inf_saques: { es: "Saques", en: "Throws", it: "Rilanci" },
  inf_achiques: { es: "Achiques", en: "Closing down", it: "Uscite" },
  ...
  inf_1x1_atq: { es: "1x1 atq.", en: "1v1 att.", it: "1c1 att." },
  inf_1x1_def: { es: "1x1 def.", en: "1v1 def.", it: "1c1 dif." },
  inf_anticipacion: { es: "Anticip.", en: "Anticip.", it: "Anticipi" },
  inf_pase_gol: { es: "P. gol", en: "Key p.", it: "P. chiave" },
  inf_ult_cob: { es: "Últ. cob.", en: "Last cover", it: "Ult. cop." },
  inf_corte_conex: { es: "Cortes conex.", en: "Conn. cuts", it: "Intercetti conn." },
  inf_conex_pivot: { es: "Conex. pívot", en: "To pivot", it: "Conn. pivot" },
  inf_recibe_pivot: { es: "Recibe pívot", en: "As pivot", it: "Riceve da pivot" },
  inf_nota_video: { es: "Ganados/intentos; en anticipaciones, buenas/total; P. gol, pases de gol (ocasión clara que no acabó en gol). Solo se cuenta en los partidos revisados con vídeo: en directo no da tiempo.", en: "Won/attempts; for anticipations, good/total; Key p., key passes (a clear chance that did not end in a goal). Only recorded in matches reviewed on video: there is no time live.", it: "Vinti/tentativi; negli anticipi, buoni/totale; P. chiave, passaggi chiave (occasione netta non finita in gol). Si conta solo nelle partite riviste con il video: dal vivo non c'è tempo." },
  // ══════════════════ GENÉRICOS / COMUNES ══════════════════
  ...
  res_disparos_de_incorporacion: {
    es: "{n} de los {total} disparos fueron de incorporación",
    en: "{n} of the {total} shots came from a keeper-up play",
    it: "{n} dei {total} tiri sono arrivati da un'incorporazione",
  },
  res_incorporaciones_total: {
    es: "{n} incorporaciones en total",
    en: "{n} keeper-up plays in total",
    it: "{n} incorporazioni in totale",
  },
  res_incorporaciones_titulo: { es: "🧤 Incorporaciones del portero rival",
                                en: "🧤 Rival goalkeeper as outfield player",
                                it: "🧤 Portiere di movimento avversario" },
  res_inc_con: { es: "con disparo", en: "with shot", it: "con tiro" },
  res_inc_sin: { es: "sin disparo", en: "no shot", it: "senza tiro" },
  ...
  saque_titulo: { es: "¿Quién saca?", en: "Who kicks off?", it: "Chi batte?" },
  saque_sub: { es: "Se anota para saber a quién le toca en la 2ª parte.",
               en: "Recorded so the app knows who kicks off the 2nd half.",
               it: "Si annota per sapere a chi tocca nel 2º tempo." },
  saque_sin_anotar: { es: "Empezar sin anotarlo",
                       en: "Start without recording it",
                       it: "Inizia senza annotarlo" },
  aviso_saca: { es: "Saca {equipo}", en: "{equipo} kicks off", it: "Batte {equipo}" },
  aviso_deshecho: { es: "Deshecho: {que}", en: "Undone: {que}", it: "Annullato: {que}" },
  aviso_pase_gol: { es: "Pase de gol de {jugador} ({origen} → {destino})", en: "Key pass by {jugador} ({origen} → {destino})", it: "Passaggio chiave di {jugador} ({origen} → {destino})" },
  aviso_pase_gol_quitado: { es: "Pase de gol de {jugador} quitado", en: "Key pass by {jugador} removed", it: "Passaggio chiave di {jugador} tolto" },
  aviso_nada_deshacer: { es: "No había nada que deshacer",
                          en: "Nothing to undo", it: "Niente da annullare" },
  ...
  vid_anticipacion: { es: "Anticipación", en: "Anticipation", it: "Anticipo" },
  // Pase de gol (18/9/2026): el pase que deja a un compañero en ocasión clara y
  // la ocasión NO acaba en gol. Fuera se entiende como «key pass» / «passaggio
  // chiave». En UNA línea: la lee acciones.test.ts.
  vid_pase_gol: { es: "Pase de gol", en: "Key pass", it: "Passaggio chiave" },
  ...
  // En femenino por «la anticipación»; en italiano es «l'anticipo», masculino.
  vid_buena: { es: "✅ Buena", en: "✅ Good", it: "✅ Buono" },
  vid_mala: { es: "❌ Mala", en: "❌ Bad", it: "❌ Cattivo" },
  ...
  mai_btn_pase_gol: { es: "➡️ PASE DE GOL", en: "➡️ KEY PASS", it: "➡️ PASSAGGIO CHIAVE" },
  mai_btn_pase_gol_sub: { es: "ocasión clara que no acabó en gol", en: "clear chance that did not end in a goal", it: "occasione netta non finita in gol" },
  pg_titulo: { es: "Pase de gol · {jugador}", en: "Key pass · {jugador}", it: "Passaggio chiave · {jugador}" },
  pg_aviso: { es: "Solo si la ocasión NO acabó en gol. Si acabó en gol, apúntalo como asistencia en el gol", en: "Only if the chance did NOT end in a goal. If it did, record it as the assist on the goal", it: "Solo se l'occasione NON è finita in gol. Se è finita in gol, segnalo come assist nel gol" },
  pg_instrucciones: { es: "Arrastra desde donde sale el pase hasta donde llega, o toca primero el origen y luego el destino.", en: "Drag from where the pass starts to where it arrives, or tap the start and then the end.", it: "Trascina da dove parte il passaggio a dove arriva, oppure tocca prima l'origine e poi la destinazione." },
  pg_toca_destino: { es: "Ahora toca dónde llega el pase.", en: "Now tap where the pass arrives.", it: "Ora tocca dove arriva il passaggio." },
  pg_muy_corta: { es: "Muy corta: la flecha tiene que medir al menos 1 metro.", en: "Too short: the arrow must be at least 1 metre long.", it: "Troppo corta: la freccia deve misurare almeno 1 metro." },
  pg_otra_vez: { es: "Toca otra vez para empezar de nuevo.", en: "Tap again to start over.", it: "Tocca di nuovo per ricominciare." },
  pg_guardar: { es: "Guardar pase de gol", en: "Save key pass", it: "Salva passaggio chiave" },
  pg_conf_titulo: { es: "¿Es la misma jugada?", en: "Is it the same move?", it: "È la stessa azione?" },
  pg_conf_gol_texto: { es: "{jugador} tiene un pase de gol a las {minuto}. Si es la jugada de este gol, sobra: con gol solo cuenta la asistencia.", en: "{jugador} has a key pass at {minuto}. If it is the move of this goal, it should go: with a goal only the assist counts.", it: "{jugador} ha un passaggio chiave al {minuto}. Se è l'azione di questo gol, va tolto: con il gol conta solo l'assist." },
  pg_quitar: { es: "Quitar el pase de gol", en: "Remove the key pass", it: "Togli il passaggio chiave" },
  pg_distintas: { es: "Son jugadas distintas", en: "They are different moves", it: "Sono azioni diverse" },
  pg_conf_pase_texto: { es: "Hay un gol nuestro a las {minuto} ({quien}). Si este pase acabó en ese gol, no es pase de gol: con gol solo cuenta la asistencia.", en: "There is a goal of ours at {minuto} ({quien}). If this pass ended in that goal, it is not a key pass: with a goal only the assist counts.", it: "C'è un nostro gol al {minuto} ({quien}). Se questo passaggio è finito in quel gol, non è un passaggio chiave: con il gol conta solo l'assist." },
  pg_otra_jugada: { es: "Es otra jugada: guardar", en: "Different move: save", it: "È un'altra azione: salva" },
  pg_en_propia: { es: "en propia puerta", en: "own goal", it: "autogol" },
  ...
  res_video_leyenda: { es: "Duelos y 1x1 = ganados-perdidos · Anticipación = buenas-malas · P. gol = pases de gol (ocasión clara sin gol) · Conexión con pívot = dadas/recibidas · Saque y pase = buenos-malos", en: "Duels & 1v1 = won-lost · Anticipation = good-bad · Key p. = key passes (clear chance, no goal) · Pivot connection = given/received · Throw & pass = good-bad", it: "Duelli e 1v1 = vinti-persi · Anticipo = buoni-cattivi · P. chiave = passaggi chiave (occasione netta senza gol) · Connessione col pivot = dati/ricevuti · Rimessa e passaggio = buoni-cattivi" },
