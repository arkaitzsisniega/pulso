...
export const CATALOGO: Record<string, Entrada> = {
  // ── Informe de partido (reescrito 31/8/2026, 13 secciones) ──
  inf_cargando: { es: "Cargando…", en: "Loading…" },
  inf_sin_partido: { es: "No hay ningún partido abierto.", en: "No match is open." },
  inf_volver: { es: "Volver", en: "Back" },
  inf_guardar_pdf: { es: "Guardar como PDF", en: "Save as PDF" },
  inf_aviso_imprimir: { es: "Se abrirá el cuadro de imprimir del iPad. Ahí eliges Guardar en Archivos, o lo compartes por correo o WhatsApp desde el mismo sitio.", en: "The iPad print dialog will open. Choose Save to Files there, or share it by email or WhatsApp from the same place." },
  inf_titulo: { es: "Informe de partido", en: "Match report" },
  inf_local: { es: "Local", en: "Home" },
  inf_visitante: { es: "Visitante", en: "Away" },
  inf_con_video: { es: "revisado con vídeo", en: "reviewed on video" },
  inf_en_directo: { es: "apuntado en directo", en: "recorded live" },
  inf_sec_goles: { es: "Goles", en: "Goals" },
  inf_sin_goles: { es: "Sin goles.", en: "No goals." },
  inf_asist: { es: "asist.", en: "assist" },
  inf_sec_equipo: { es: "Estadísticas del partido", en: "Match statistics" },
  inf_disparos: { es: "Disparos", en: "Shots" },
  inf_a_puerta: { es: "A puerta", en: "On target" },
  inf_fuera: { es: "Fuera", en: "Off target" },
  inf_palo: { es: "Al palo", en: "Woodwork" },
  inf_bloqueados: { es: "Bloqueados", en: "Blocked" },
  inf_faltas: { es: "Faltas", en: "Fouls" },
  inf_amarillas: { es: "Amarillas", en: "Yellow cards" },
  inf_tm: { es: "Tiempos muertos", en: "Timeouts" },
  inf_robos: { es: "Robos", en: "Steals" },
  inf_cortes: { es: "Cortes", en: "Interceptions" },
  inf_perdidas: { es: "Pérdidas", en: "Turnovers" },
  inf_divididos: { es: "Divididos", en: "50-50s" },
  inf_sec_jugadores: { es: "Jugadores de campo", en: "Outfield players" },
  inf_jugador: { es: "Jugador", en: "Player" },
  inf_min: { es: "Min", en: "Min" },
  inf_asist_col: { es: "Asist.", en: "Ast." },
  inf_disp: { es: "Disp.", en: "Sh." },
  inf_pta: { es: "A pta.", en: "On tgt." },
  inf_perd: { es: "Pérd.", en: "TO" },
  inf_bd: { es: "Divid.", en: "50-50" },
  inf_nota_masmenos: { es: "± = goles a favor menos goles en contra con ese jugador en pista.", en: "± = goals for minus goals against while that player was on court." },
  inf_sec_porteros: { es: "Porteros", en: "Goalkeepers" },
  inf_portero: { es: "Portero", en: "Goalkeeper" },
  inf_paradas: { es: "Paradas", en: "Saves" },
  inf_encajados: { es: "Encajados", en: "Conceded" },
  inf_pct_parada: { es: "% parada", en: "Save %" },
  inf_sec_cronograma: { es: "Rotaciones", en: "Rotations" },
  inf_nota_cronograma: { es: "Cada barra son los tramos que ese jugador estuvo en pista, de principio a fin del partido.", en: "Each bar shows the spells that player spent on court, from start to end of the match." },
  inf_sec_quintetos: { es: "Rendimiento por quinteto", en: "Performance by lineup" },
  ...
  inf_nota_tramos: {
    es: "Goles por tramos de cinco minutos. En verde los nuestros, en gris los del rival.",
    en: "Goals in five-minute blocks. Ours in green, the opponent's in grey.",
    it: "Gol in blocchi di cinque minuti. In verde i nostri, in grigio quelli avversari.",
  },
  ...
  inf_nota_campo: {
    es: "Cada zona lleva el número de disparos que salieron de ahí; cuanto más intenso, más se tiró. El campo se pinta en el sentido en que atacamos en la primera parte.",
  ...
  inf_quinteto: { es: "Quinteto", en: "Lineup" },
  inf_gf: { es: "GF", en: "GF" },
  inf_gc: { es: "GC", en: "GA" },
  inf_nota_quintetos: { es: "Los diez quintetos con más minutos. ± = goles a favor menos en contra con ellos en pista.", en: "The ten lineups with most minutes. ± = goals for minus against while on court." },
  inf_sec_jugadas: { es: "Goles por tipo de jugada", en: "Goals by type of play" },
  inf_jugada: { es: "Jugada", en: "Play" },
  inf_sec_zonas: { es: "Mapas de zona", en: "Zone maps" },
  inf_z_porteria_favor: { es: "Portería · a favor", en: "Goal mouth · for" },
  inf_z_campo_favor: { es: "Zonas de disparo · a favor", en: "Shooting zones · for" },
  inf_z_porteria_contra: { es: "Portería · en contra", en: "Goal mouth · against" },
  inf_z_campo_contra: { es: "Zonas de disparo · en contra", en: "Shooting zones · against" },
  inf_sec_video: { es: "Duelos y uno contra uno", en: "Duels and one-on-ones" },
  inf_video_porteros: { es: "Porteros", en: "Goalkeepers" },
  inf_saques: { es: "Saques", en: "Throws" },
  inf_achiques: { es: "Achiques", en: "Closing down" },
  inf_cob_balon: { es: "Cob. balón", en: "Ball cover" },
  inf_cob_hombre: { es: "Cob. hombre", en: "Man cover" },
  inf_pases: { es: "Pases", en: "Passes" },
  inf_sec_otros: { es: "Penaltis, 10 metros y tarjetas", en: "Penalties, 10m and cards" },
  inf_penaltis: { es: "Penaltis y 10 metros", en: "Penalties and 10m" },
  inf_tarjetas: { es: "Tarjetas", en: "Cards" },
  inf_duelo_c: { es: "Duelo cierre", en: "Defender duel" },
  inf_duelo_p: { es: "Duelo pívot", en: "Pivot duel" },
  inf_1x1_atq: { es: "1x1 atq.", en: "1v1 att." },
  inf_1x1_def: { es: "1x1 def.", en: "1v1 def." },
  inf_ult_cob: { es: "Últ. cob.", en: "Last cover" },
  inf_corte_conex: { es: "Cortes conex.", en: "Conn. cuts" },
  inf_conex_pivot: { es: "Conex. pívot", en: "To pivot" },
  inf_recibe_pivot: { es: "Recibe pívot", en: "As pivot" },
  inf_nota_video: { es: "Ganados/intentos. Solo se cuenta en los partidos revisados con vídeo: en directo no da tiempo.", en: "Won/attempts. Only recorded in matches reviewed on video: there is no time live." },
  // ══════════════════ GENÉRICOS / COMUNES ══════════════════
