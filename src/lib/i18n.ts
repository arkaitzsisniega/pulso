...
export const CATALOGO: Record<string, Entrada> = {
  ...
  inf_nota_video: { es: "Ganados/intentos; en anticipaciones, buenas/total. Solo se cuenta en los partidos revisados con vídeo: en directo no da tiempo.", en: "Won/attempts; for anticipations, good/total. Only recorded in matches reviewed on video: there is no time live.", it: "Vinti/tentativi; negli anticipi, buoni/totale. Si conta solo nelle partite riviste con il video: dal vivo non c'è tempo." },
  // ══════════════════ GENÉRICOS / COMUNES ══════════════════
  ...
  res_video_leyenda: { es: "Duelos y 1x1 = ganados-perdidos · Anticipación = buenas-malas · Conexión con pívot = dadas/recibidas · Saque y pase = buenos-malos", en: "Duels & 1v1 = won-lost · Anticipation = good-bad · Pivot connection = given/received · Throw & pass = good-bad", it: "Duelli e 1v1 = vinti-persi · Anticipo = buoni-cattivi · Connessione col pivot = dati/ricevuti · Rimessa e passaggio = buoni-cattivi" },
