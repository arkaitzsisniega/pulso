...
export const CATALOGO: Record<string, Entrada> = {
  ...
  inf_nota_video: { es: "Ganados/intentos. Solo se cuenta en los partidos revisados con vídeo: en directo no da tiempo.", en: "Won/attempts. Only recorded in matches reviewed on video: there is no time live.", it: "Vinti/tentativi. Si conta solo nelle partite riviste con il video: dal vivo non c'è tempo." },
  // ══════════════════ GENÉRICOS / COMUNES ══════════════════
